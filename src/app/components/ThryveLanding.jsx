...
const reviews = [
  ...
  { quote: "Simple stack that actually makes slense. Makes me happy to know I'm supporting not just muscle longevity but also brain longevity.",   name: "Marcus R.", rating: 5.0 },
...
export default function ThryveLanding() {
  ...
  return (
    ...
    <div className="min-h-screen bg-white text-gray-900 antialiased overflow-x-hidden">
      ...
      <div
        data-sticky-cta
        className={`fixed left-0 right-0 top-0 z-[9999] transition-transform duration-300 ${sticky ? 'translate-y-0' : '-translate-y-full'}`}
      >
                ...
                <li key={b.text} className="flex items-center gap-3 md:gap-4">
                  <div className="flex h-10 w-10 md:h-14 md:w-14 items-center justify-center rounded-2xl bg-emerald-50 ring-1 ring-emerald-100">
                    <Image
                      ...
                      width={44}
                      height={44}
                      className="h-6 w-6 md:h-11 md:w-11 object-contain"
                    />
                  </div>
